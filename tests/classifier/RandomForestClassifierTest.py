...
from onl.nok.sklearn.classifier.RandomForestClassifier import RandomForestClassifier
...
class RandomForestClassifierTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.clf = RFC(n_estimators=100, random_state=0)
